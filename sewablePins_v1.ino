...
an LED and alligator clips which pins can be programmed
and should be sewn to. Literally just routes power to all
...
for (counterVariable = 0;counterVariable < 8; counterVariable++){
  analogWrite(pinsArray[counterVariable], 150);
 }
